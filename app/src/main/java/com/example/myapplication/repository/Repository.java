...
public class Repository {
    ...
    private ApiRequest apiFBResult;
    ...
    public Repository(Context context) {
        ...
        apiResult = RetrofitRequest.getResultFacebook(context).create(ApiRequest.class);
    ...
    public LiveData<FacebookUserModel> getResultFacebook() {
        final MutableLiveData<FacebookUserModel> data = new MutableLiveData<>();
        String fields = "id,name,first_name,last_name,email";
        apiResult.getResultsFacebook(fields).enqueue(new Callback<FacebookUserModel>() {
            @Override
